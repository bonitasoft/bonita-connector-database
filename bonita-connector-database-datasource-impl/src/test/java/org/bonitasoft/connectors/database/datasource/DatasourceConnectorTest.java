...
public class DatasourceConnectorTest {
    ...
    @Cover(classes = { DatasourceConnector.class }, concept = BPMNConcept.CONNECTOR, keywords = { "database", "datasource" },
    ...
    public void testValidateInputWithGoodParameters() throws ConnectorValidationException {
        DatasourceConnector datasourceConnector =
                getDatasourceConnectorWithParameters(Collections.singletonMap(DatasourceConnector.SCRIPT, (Object) getFirstInsertQuery()));
        datasourceConnector.validateInputParameters();
    }
    ...
    public void testValidateInputWithEmptyParameters() {
        Map<String, Object> parameters = new HashMap<String, Object>();
        parameters.put(DatasourceConnector.DATASOURCE, "");
        parameters.put(DatasourceConnector.PROPERTIES, new ArrayList<Object>());
        parameters.put(DatasourceConnector.SCRIPT, "");
        DatasourceConnector datasourceConnector = new DatasourceConnector();
        datasourceConnector.setInputParameters(parameters);
        try {
            datasourceConnector.validateInputParameters();
    ...
    public void testInsertOneLine() throws Exception {
        final DatasourceConnector datasourceConnector = getDatasourceConnectorWithParameters(Collections.singletonMap(DatasourceConnector.SCRIPT,
    ...
    public void testUpdate() throws Exception {
        DatasourceConnector datasourceConnector = getDatasourceConnectorWithParameters(Collections.singletonMap(DatasourceConnector.SCRIPT,
                (Object) getUpdateAgeOf("John", "44")));
        datasourceConnector.connect();
        datasourceConnector.execute();
        datasourceConnector.disconnect();

        datasourceConnector = getDatasourceConnectorWithParameters(Collections.singletonMap(DatasourceConnector.SCRIPT, (Object) getAgeOf("John")));
        final List<List<Object>> rowSet = executeAndGetResult(datasourceConnector);
        assertEquals(1, rowSet.size());
        assertEquals(1, rowSet.get(0).size());
    ...
    public void testCreateSelectAndDropTable() throws Exception {
        ...
        datasourceConnector = getDatasourceConnectorWithParameters(Collections.singletonMap(DatasourceConnector.SCRIPT, (Object) getDeleteFirstInsert()));
        datasourceConnector.connect();
        datasourceConnector.execute();
        datasourceConnector.disconnect();

        datasourceConnector = getDatasourceConnectorWithParameters(Collections.singletonMap(DatasourceConnector.SCRIPT, (Object) getSelectAllQuery()));
    ...
    public void executeBatchScript() throws Exception {
        ...
        parameters.put(DatasourceConnector.SCRIPT, script);
        parameters.put(DatasourceConnector.SEPARATOR, ";");
    ...
    private DatasourceConnector getDatasourceConnectorWithParameters(final Map<String, Object> parameters) {
        ...
        defaultParameters.put(DatasourceConnector.PROPERTIES, properties);
        defaultParameters.put(DatasourceConnector.SCRIPT, getSelectAllQuery());
    ...
    private Map<String, Object> initiateConnectionParameters() {
        ...
        defaultParameters.put(DatasourceConnector.DATASOURCE, DATASOURCE);
    ...
    private void insertValues() throws Exception {
        ...
        datasourceConnector.execute();
        datasourceConnector.disconnect();
        datasourceConnector = getDatasourceConnectorWithParameters(Collections.singletonMap(DatasourceConnector.SCRIPT, (Object) getSecondInsertQuery()));
        datasourceConnector.connect();
        datasourceConnector.execute();
        datasourceConnector.disconnect();
    }
    ...
    private String getBatchScript(final String separator) {
        String strBatchScript = prop.getProperty("batch_script");
